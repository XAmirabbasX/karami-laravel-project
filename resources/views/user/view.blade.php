...
<head>
    ...
    <!--    SwiperJs Styles-->
    <link rel="stylesheet" href="{{asset('assets/css/vendors/swiper/swiper-bundle.min.css')}}">
    <!--    Main Styles-->
    <link rel="stylesheet" href="{{asset('assets/css/style.css')}}">
    <!--    Nice Select-->
    <link rel="stylesheet" href="{{asset('assets/css/vendors/niceselect/nice-select.css')}}">
</head>
<!--Head::end-->
                ...
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="top-mobile-navbar-middle d-flex justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0)" class="navbar-brand">
                            <img src="{{asset('assets/img/logo.png')}}" alt="لوگوی برگ شاپ" class="blur-up">
                        </a>
                        <!--            Logo:end-->
                    </div>
        ...
        <div class="top-navbar navbar-expand-lg navbar-light py-2">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="top-nav-right d-flex justify-content-between align-items-center">
                    <!--            Logo:start-->
                    <a href="javascript:void(0)" class="navbar-brand">
                        <img src="{{asset('assets/img/logo-md.png')}}" alt="لوگوی برگ شاپ" class="blur-up">
                    </a>
                    <!--            Logo:end-->
...
<div class="custom-navbar" id="customNavbar">
    ...
    <a href="" class="ads-banner" title="">
        <img src="{{asset('assets/img/ads-banner.jpg')}}" alt="" class="img-fluid object-cover">
    </a>
    <!--        Ads Banner:end-->
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="top-nav-right d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('index')}}" class="navbar-brand" title="">
                    <img src="{{asset('assets/img/logo-md.png')}}" alt="لوگوی برگ شاپ">
                </a>
                <!--            Logo:end-->
            ...
            <div class="top-nav-left d-flex justify-content-between align-items-center">
                ...
                @if(auth()->id())
                    <div class="dropdown user-panel-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item fw-bold py-3" href="{{route('user.showProfileInfo', auth()->id())}}">
                ...
                <div class="shopping-cart-wrapper position-relative ms-2">
                    <!--            Shopping Cart Button:start-->
                    <a href="empty-cart.blade.php" class="btn shopping-cart-btn position-relative border-radius-xl" title="">
                        <!--begin::Svg Icon-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="card shopping-cart-box position-absolute border-0 custom-box-shadow-s-1 overflow-hidden border-radius-xl">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center bg-white fs-7">
                            ...
                            <a href="{{route('User.cart')}}" class="text-info fw-bold" title="">
                                مشاهده سبد خرید
                        ...
                        <div class="card-body cartParent">
                            ...
                            <div class="shopping-cart-item d-flex justify-content-between align-items-center py-3 border-bottom-gray-150">
                                ...
                                <div class="shopping-cart-item-right me-3">
                                    <img src="{{asset('assets/img/laptop-1.jpg')}}" alt="image" class="object-contain">
                            ...
                            <div class="shopping-cart-item d-flex justify-content-between align-items-center py-3 border-bottom-gray-150">
                                <!--                    Shopping Cart Item Right:start-->
                                <div class="shopping-cart-item-right me-3">
                                    <img src="{{asset('assets/img/laptop-2.jpg')}}" alt="image" class="object-contain">
                                    <div class="shop-item-edit-box d-flex justify-content-between align-items-center px-3 pt-2 pb-1 border-radius-xl">
                                        <span class="addition"><i class="fas fa-plus"></i></span>
                                        <span class="fs-5">1</span>
                                        <span class="decrease"><i class="far fa-trash-alt"></i></span>
                            ...
                            <div class="shopping-cart-item d-flex justify-content-between align-items-center py-3 border-bottom-gray-150">
                                <!--                    Shopping Cart Item Right:start-->
                                <div class="shopping-cart-item-right me-3">
                                    <img src="{{asset('assets/img/laptop-3.jpg')}}" alt="image" class="object-contain">
                                    <div class="shop-item-edit-box d-flex justify-content-between align-items-center px-3 pt-2 pb-1 border-radius-xl">
                                        <span class="addition"><i class="fas fa-plus"></i></span>
                                        <span class="fs-5">1</span>
                                        <span class="decrease"><i class="far fa-trash-alt"></i></span>
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="top-mobile-navbar-middle d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('index')}}" class="navbar-brand pb-2" title="">
                        <img src="{{asset('assets/img/logo.png')}}" alt="لوگوی برگ شاپ">
                    </a>
                    <!--            Logo:end-->
                </div>
                <!--        Top Mobile Navbar Middle:end-->
    ...
    <nav class="main-navbar navbar navbar-expand-lg navbar-light bg-light custom-box-shadow-s-1-bottom py-1 w-100"
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 d-flex justify-content-between align-items-center position-relative">
                            ...
                            @if($categories->count()>0)
                                @foreach($categories as $category)
                                    <li class="nav-item-submenu-child">
                                        <a href="single-product.blade.php" class="fw-bold" title="">
                                            <!--begin::Svg Icon-->
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <ul class="position-absolute top-0 bg-white custom-box-shadow-s-2">
                                            ...
                                            @foreach($category->children as $categoryChild)
                                                <li>
                                                    <a href="single-product.blade.php" title="">
                                                        {{$categoryChild->title}}
                                                    </a>
                                                </li>
                                            @endforeach
                    ...
                    <li class="nav-item d-flex justify-content-between align-items-center me-2 position-relative">
                        ...
                        <ul class="position-absolute bg-white custom-box-shadow-s-2 nav-item-submenu">
                            ...
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 1</a>
                            </li>
                            <!--                        Navbar Item Child:end-->

                            <!--                        Navbar Item Child:start-->
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 2</a>
                            </li>
                            <!--                        Navbar Item Child:end-->

                            <!--                        Navbar Item Child:start-->
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 3</a>
                            </li>
                            <!--                        Navbar Item Child:end-->

                            <!--                        Navbar Item Child:start-->
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 4</a>
                            </li>
                            <!--                        Navbar Item Child:end-->

                            <!--                        Navbar Item Child:start-->
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 5</a>
                            </li>
                            <!--                        Navbar Item Child:end-->

                            <!--                        Navbar Item Child:start-->
                            <li class="nav-item-submenu-child"><a href="single-product.blade.php" title="">زیر منوی 6</a>
                            </li>
                            <!--                        Navbar Item Child:end-->
                        </ul>
                        <!--                    Navbar Child Wrapper:end-->
        ...
        <div class="main-mobile-navbar pb-1">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="main-mobile-navbar-left">
                    <!--            Login and Register:start-->
                    <a href="login.blade.php" class="btn text-dark-blue border-radius-xl" title="">
                        <!--begin::Svg Icon -->
                    ...
                    <!--            Shopping Cart Button:start-->
                    <a href="empty-cart.blade.php" class="btn shopping-cart-btn p-2 border-radius-xl position-relative"
                       title="">
                        <!--begin::Svg Icon-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1">
    ...
    <div class="container">
        <div class="footer-top mt-4 mb-5">
            ...
            <div class="footer-top-detial d-flex justify-content-between align-items-center">
                <div class="">
                    <a href="" title=""><img src="{{asset('assets/img/logo-md.png')}}" alt=""></a>
            ...
            <div class="footer-top-attr d-flex justify-content-between align-items-center my-5">
                ...
                <div class="top-right-item text-center">
                    <img src="assets/img/express-delivery.svg" alt="" title="">
                ...
                <!--                Top Right Item:start-->
                <div class="top-right-item text-center">
                    <img src="assets/img/cash-on-delivery.svg" alt="" title="">
                ...
                <!--                Top Right Item:start-->
                <div class="top-right-item text-center">
                    <img src="assets/img/support.svg" alt="" title="">
                ...
                <!--                Top Right Item:start-->
                <div class="top-right-item text-center">
                    <img src="{{asset('assets/img/days-return.svg')}}" alt="" title="">
                ...
                <!--                Top Right Item:start-->
                <div class="top-right-item text-center">
                    <img src="{{asset('assets/img/original-products.svg')}}" alt="" title="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-3 d-flex justify-content-evenly align-items-center">
                    <img src="{{asset('assets/img/symbol-01.png')}}" alt="" title=""
                         class="img-fluid border border-gray-200 border-radius-xl">
                    <img src="{{asset('assets/img/symbol-02.png')}}" alt="" title=""
                         class="img-fluid border border-gray-200 border-radius-xl">
                </div>
            </div>
        </div>
...
<!--Jquery Nice Select:start-->
<script src="{{asset('assets/js/vendors/jquery/jquery.nice-select.min.js')}}"></script>
<!--Jquery Nice Select:end-->
