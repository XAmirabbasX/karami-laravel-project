...
<div class="action-wrapper d-flex justify-content-center align-items-center h-100">
    <div class="form p-4 border border-radius-3xl border-gray-200">
        ...
        <form method="post" action="{{route('loginRequest')}}">
            @csrf
            <input name="phone" type="text" @error('phone') placeholder="شماره موبایل خود را وارد کنید" @enderror class="@error('phone') is-invalid @enderror form-control border-radius-xl">
            <div class="d-grid gap-2 mt-3">
                <button type="submit" class="btn btn-danger btn-block border-radius-xl fw-bold">ورود</button>
            </div>
        </form>
        <p class="text-center mt-3 gray-600 fs-7">ورود شما به معنای پذیرش شرایط و قوانین برگ شاپ است.</p>
    </div>
</div>
</body>
<!--Body::end-->
