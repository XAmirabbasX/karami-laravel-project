                    ...
                    <ul class="menu-nav ">
                        ...
                        <li class="menu-item  menu-item-active" aria-haspopup="true">
                            <a href="{{route('admin.logout')}}"  class="menu-link ">
                                ...
                                </svg><!--end::Svg Icon--></span><span class="menu-text">خروج</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">برند ها</span><i class="menu-arrow"></i>
                            </a>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('brand.create')}}" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">اضافه کردن برند</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="{{route('brand.index')}}" class="menu-link ">
                                            ...
                                            <span class="menu-text">مشاهده برند ها</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">دسته بندی ها</span><i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu ">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('category.create')}}" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">اضافه کردن دسته بندی</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="{{route('category.index')}}" class="menu-link ">
                                            ...
                                            <span class="menu-text">مشاهده دسته ها</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">محصولات</span><i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu ">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('product.create')}}" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">اضافه کردن محصول</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="{{route('product.index')}}" class="menu-link ">
                                            ...
                                            <span class="menu-text">مشاهده محصولات</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">مدیران</span><i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu ">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{route('admin.create')}}" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">اضافه کردن مدیر</span>
                                        </a>
                                    </li>

                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="{{route('admin.showAdmins')}}" class="menu-link ">
                                            <i class="menu-bullet menu-bullet-line">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">مشاهده مدیران</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
